  ...
  template: `
    <div class="exposure-checker-container animate__animated animate__fadeIn">
      ...
      <div class="glass-panel p-4 mb-5 shadow-lg text-center border-0">
        ...
        <p class="text-on-surface-variant opacity-75 mb-0">Cross-reference target intelligence against known global breach vectors</p>
      </div>
      ...
      <div class="max-width-800 mx-auto mb-5">
        <div class="search-pill-outer animate__animated animate__fadeInDown" [class.is-loading]="loading">
          <div class="d-flex align-items-center w-100 h-100">
            ...
            <div class="pe-2">
              <button
                class="pill-button btn btn-primary px-4 fw-bold text-xs-caps"
                [disabled]="loading"
                (click)="performCheck()">
                @if (!loading) {
        ...
        <div class="row g-4 animate__animated animate__fadeInUp">
          <div class="col-md-4" (click)="focusSearch()">
            <div class="glass-panel p-4 h-100 shadow-lg text-center card-interactive border-0">
              ...
              <p class="text-on-surface-variant small mb-0 opacity-75">Verified breach events available for immediate cross-reference scanning.</p>
            </div>
          </div>
          <div class="col-md-4" (click)="focusSearch()">
            <div class="glass-panel p-4 h-100 shadow-lg text-center card-interactive border-0">
              ...
              <p class="text-on-surface-variant small mb-0 opacity-75">Harvested records indexed from high-priority leak sites and forums.</p>
            </div>
          </div>
          <div class="col-md-4" (click)="focusSearch()">
            <div class="glass-panel p-4 h-100 shadow-lg text-center card-interactive border-0">
              ...
              <p class="text-on-surface-variant small mb-0 opacity-75">High-threat vectors requiring immediate authentication rotation protocols.</p>
            </div>
          </div>
        </div>
      }
        ...
        <div class="row g-4 mb-5 animate__animated animate__fadeIn">
          <div class="col-lg-4">
            <div class="glass-panel p-4 shadow-lg h-100 d-flex flex-column justify-content-between border-top border-4"
              ...
              <div>
                ...
                <div class="p-4 rounded-3 d-flex align-items-center gap-4 shadow-inner bg-surface-container-high border border-outline-variant border-opacity-10">
                  ...
                  <div>
                    ...
                    <div class="text-xs-caps text-on-surface-variant opacity-75" style="font-size: 9px;">
              ...
              <div class="mt-4">
                ...
                <div class="text-center text-xs-caps opacity-50 py-3 text-on-surface-variant" *ngIf="!results.exposed" style="font-size: 8px;">
          ...
          <div class="col-lg-8">
            <div class="glass-panel p-4 shadow-lg h-100 overflow-hidden">
              <h2 class="text-xs-caps text-on-surface-variant border-bottom border-outline-variant border-opacity-10 pb-2 mb-4">INFILTRATION LOGS</h2>
              <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 text-on-surface">
                  <thead>
                    <tr class="text-xs-caps opacity-50 border-bottom border-outline-variant border-opacity-10">
                  ...
                  <tbody>
                    @for (b of results.breaches; track b._id; let i = $index) {
                      <tr class="border-bottom border-outline-variant border-opacity-5 hover-bg-surface-container-high cursor-pointer" [routerLink]="['/breaches', b._id]">
                        <td class="font-mono small py-3 opacity-75">{{ b.created_at | date:'yyyy.MM.dd Z' }}</td>
                        <td class="fw-bold small py-3" [ngClass]="i % 2 === 0 ? 'text-primary' : 'text-secondary'">{{ getOrgName(b) | uppercase }}</td>
                        <td class="text-xs-caps opacity-75 py-3 text-on-surface-variant" style="font-size: 8px;">{{ b.industry | uppercase }}</td>
                    ...
                    @if (!results.breaches || results.breaches.length === 0) {
                      <tr><td colspan="4" class="text-center py-5 opacity-25 text-xs-caps text-on-surface">NO DATA RECORDS AVAILABLE</td></tr>
                    }
                  </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-6">
            <div class="glass-panel p-3 shadow-lg h-100">
              <h2 class="text-xs-caps text-on-surface-variant px-2 mb-3">GLOBAL VECTOR MAP</h2>
          ...
          <div class="col-lg-6">
            <div class="glass-panel p-4 shadow-lg h-100">
              <h2 class="text-xs-caps text-on-surface-variant border-bottom border-outline-variant border-opacity-10 pb-2 mb-4">RECOMMENDED PROTOCOLS</h2>
              <ul class="list-unstyled d-flex flex-column gap-4">
                <li class="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <div class="small opacity-75 text-on-surface-variant">Immediate forced password reset across all linked domains recommended.</div>
                  </div>
                </li>
                <li class="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <div class="small opacity-75 text-on-surface-variant">Elevate authentication protocols to physical token requirements.</div>
                  </div>
                </li>
                <li class="d-flex gap-3">
                  ...
                  <div>
                    ...
                    <div class="small opacity-75 text-on-surface-variant">Review cross-domain authorization grants for unauthorized persistence.</div>
                  </div>
                </li>
              </ul>
            </div>
